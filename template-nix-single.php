<div class="content-wrap">
  <div id="content" class="section group">
    <div class="col span_8_of_12">
      <form id="frm-download-receita" method="post" action="https://crochepassoapasso.com.br/download?donotcachepage=b738da17de3504532ff05cc266a6a694">
              ...
              <div class="post-content font-hind">
                ...
                if($urlDownload != ""){
                  ...
                  <p style="text-align:center;">
                    <a title="Download <?=$title_post?>" href="javascript:void(0);" onclick="fncAbreMessiDownloadReceita('<?=$urlDownload?>', '<?=$link_post?>');">
                      <img alt="Download <?=$title_post?>" title="Download Receita" src="https://crochepassoapasso.com.br/dwnl/download.jpg" />
                    </a>
                  </p>
                  <?php
                }
